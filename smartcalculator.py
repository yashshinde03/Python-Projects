...
operations = {'ADD':add,'ADDITION':add,'SUM':add,'PLUS':add,'SUB':sub,'DIFFERENCE':sub,'MINUS':sub,'SUBTRACT':sub,
              'LCM':lcm,'HCF':hcf,'PRODUCT':mul,'MULTIPLICATION':mul,'MULTIPLY':mul,'DIVISION':div,'DIV':div,'MOD':mod
...
l1.place(x=150,y=10)
l2 = Label(win,text='My name is Pycharm',padx=3)
l2.place(x=165,y=40)
l2 = Label(win,text='What can I help you',padx=3)
l2.place(x=165,y=40)
